...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::recurring::list_recurring_progress_entries,
            commands::recurring::create_recurring_task,
            commands::recurring::update_recurring_task,
            commands::recurring::delete_recurring_task,
            commands::recurring::create_recurring_progress_entry,
            commands::recurring::update_recurring_progress_entry,
