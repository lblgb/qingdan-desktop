...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::recurring::list_recurring_tasks,
            commands::recurring::list_recurring_periods,
            commands::recurring::list_recurring_time_entries,
            commands::recurring::create_recurring_task,
            commands::recurring::update_recurring_task,
            commands::recurring::delete_recurring_task,
            commands::recurring::create_recurring_time_entry,
            commands::recurring::update_recurring_time_entry_note,
            commands::recurring::delete_recurring_time_entry,
