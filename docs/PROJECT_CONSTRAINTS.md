...
- 当前手工验收清单：[`docs/V040_ACCEPTANCE.md`](./V040_ACCEPTANCE.md)
- 当前工作日志入口：[`docs/WORKLOG.md`](./WORKLOG.md)

> `v0.40.0` 继续执行“文档先行”原则。任何新增范围、验收项、实现边界或行为变化，都应先更新架构文档、验收文档或本文档，再进入代码实现。
